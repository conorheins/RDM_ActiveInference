...
% p = 0.8; % noise parameter, standard deviation of Gaussian distribution centered around RDP motion direction
% MDPshallow = initialize_MDPshallow_witha(p);

% noise parameter, manipulates the coherence of dot motion via the temperature parameter of a softmax transformation of
...
% MDPshallow = initialize_MDPshallow_witha_newp(p,T);
MDPshallow = initialize_MDPshallow_28112018(p,T,policy_depth);
